...
const TOOLS = [
    { id: 'generate_cad', label: 'Générer CAD' },
    { id: 'run_web_agent', label: 'Agent Web' },
    { id: 'create_directory', label: 'Créer Dossier' },
    { id: 'write_file', label: 'Écrire Fichier' },
    { id: 'read_directory', label: 'Lire Répertoire' },
    { id: 'read_file', label: 'Lire Fichier' },
    { id: 'create_project', label: 'Créer Projet' },
    { id: 'switch_project', label: 'Changer Projet' },
    { id: 'list_projects', label: 'Lister Projets' },
    { id: 'list_smart_devices', label: 'Lister Appareils' },
    { id: 'control_light', label: 'Contrôler Lumière' },
    { id: 'discover_printers', label: 'Découvrir Imprimantes' },
    { id: 'print_stl', label: 'Imprimer Modèle 3D' },
    { id: 'iterate_cad', label: 'Itérer CAD' },
];
    ...
    return (
        <div className="absolute top-20 right-10 bg-black/90 border border-cyan-500/50 p-4 rounded-lg z-50 w-80 backdrop-blur-xl shadow-[0_0_30px_rgba(6,182,212,0.2)]">
            <div className="flex justify-between items-center mb-4 border-b border-cyan-900/50 pb-2">
                <h2 className="text-cyan-400 font-bold text-sm uppercase tracking-wider">Paramètres</h2>
            ...
            <div className="mb-6">
                <h3 className="text-cyan-400 font-bold mb-3 text-xs uppercase tracking-wider opacity-80">Sécurité</h3>
                <div className="flex items-center justify-between text-xs bg-gray-900/50 p-2 rounded border border-cyan-900/30">
                    <span className="text-cyan-100/80">Authentification Faciale</span>
                    <button
            ...
            {/* Speaker Section */}
            <div className="mb-4">
                <h3 className="text-cyan-400 font-bold mb-2 text-xs uppercase tracking-wider opacity-80">Haut-parleur</h3>
                <select
            ...
            {/* Webcam Section */}
            <div className="mb-6">
                <h3 className="text-cyan-400 font-bold mb-2 text-xs uppercase tracking-wider opacity-80">Caméra</h3>
                <select
            ...
            <div className="mb-6">
                <div className="flex justify-between mb-2">
                    <h3 className="text-cyan-400 font-bold text-xs uppercase tracking-wider opacity-80">Sensibilité Curseur</h3>
            ...
            <div className="mb-6">
                <h3 className="text-cyan-400 font-bold mb-3 text-xs uppercase tracking-wider opacity-80">Contrôle Gestuel</h3>
                <div className="flex items-center justify-between text-xs bg-gray-900/50 p-2 rounded border border-cyan-900/30">
                    <span className="text-cyan-100/80">Inverser Caméra Horizontalement</span>
                    <button
            ...
            <div className="mb-6">
                <h3 className="text-cyan-400 font-bold mb-3 text-xs uppercase tracking-wider opacity-80">Confirmations d'Outils</h3>
            ...
            {/* Memory Section */}
            <div>
                <h3 className="text-cyan-400 font-bold mb-2 text-xs uppercase tracking-wider opacity-80">Données Mémoire</h3>
                <div className="flex flex-col gap-2">
                    <label className="text-[10px] text-cyan-500/60 uppercase">Charger Mémoire Texte</label>
                    <input
                        type="file"
                        accept=".txt"
