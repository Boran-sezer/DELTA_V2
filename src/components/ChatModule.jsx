        ...
        >
            ...
            <div className="flex gap-2 relative z-10 absolute bottom-4 left-6 right-6">
                <input
                    ...
                    placeholder="INITIALISER COMMANDE..."
            ...
            {isModularMode && <div className={`absolute -top-6 left-0 text-xs font-bold tracking-widest ${activeDragElement === 'chat' ? 'text-green-500' : 'text-yellow-500/50'}`}>MODULE CHAT</div>}
        </div>
    );
};
