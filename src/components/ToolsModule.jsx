...
import { Mic, MicOff, Settings, Power, Video, VideoOff, Hand, Globe, Box, Sparkles } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-center gap-6 relative z-10">
                ...
                {/* Améliorer DELTA Button */}
                <button
                    onClick={onImprove}
                    className="p-3 rounded-full border-2 transition-all duration-300 border-pink-500 bg-pink-500/10 text-pink-500 hover:bg-pink-500/20 shadow-[0_0_15px_rgba(236,72,153,0.3)] hover:shadow-[0_0_25px_rgba(236,72,153,0.5)]"
                    title="Améliorer DELTA"
                >
                    <Sparkles size={24} />
                </button>
            </div>
