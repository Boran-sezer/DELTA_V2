...
if not API_KEY:
    raise ValueError("Please set GEMINI_API_KEY_1 or GEMINI_API_KEY in your .env file")
...
class WebAgent:
    def __init__(self):
        # Forcer l'API v1 (stable) au lieu de v1beta
        self.client = genai.Client(http_options={"api_version": "v1"}, api_key=API_KEY)
        self.browser = None
        self.context = None
        self.page = None
    ...
    async def run_task(self, prompt, update_callback=None):
        ...
        async with async_playwright() as p:
            ...
            # Configuration simple sans thinking (pas supporté par v1)
